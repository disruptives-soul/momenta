  ...
  return (
    <footer className="border-t border-white/70 bg-surface/72">
      <Container className="flex min-h-20 flex-wrap items-center justify-between gap-5 py-5 text-sm text-muted-foreground">
        <Link className="inline-flex items-center gap-2 font-semibold text-foreground" href="/">
        ...
        <nav className="flex flex-wrap gap-7">
          ...
          <Link href="/catalog?type=banner">Flyers</Link>
          <Link href="/catalog?type=stickers">Stickers</Link>
          <Link href="/projects/demo-space-birthday/review">Carrito</Link>
        </nav>
        <p>© 2026 Momenta - Disenos para imprimir</p>
      </Container>
    </footer>
  );
}
