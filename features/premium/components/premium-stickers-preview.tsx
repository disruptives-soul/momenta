...
export function PremiumStickersPreview({
  ...
  return (
    <figure>
      <div
        aria-label="Preview simulado del Stickers pack con 12 stickers circulares"
        className={cn(
      ...
      >
        <div className="flex h-full flex-col rounded-sm border border-dashed border-accent/45 bg-[#fffaf0] p-4">
          <div className="mb-4 flex items-center justify-between gap-3">
            <Badge tone="premium">Preview Premium</Badge>
          ...
          <p className="mt-4 text-center text-xs text-muted-foreground">
            Placeholder visual · 12 stickers · 5 cm
          </p>
        </div>
      </div>
      <figcaption className="mx-auto mt-3 max-w-sm text-sm text-muted-foreground">
        Representación provisional: se reemplazará por el preview final del pack.
      </figcaption>
    </figure>
  );
}
